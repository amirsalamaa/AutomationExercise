...
public class ProductsPage {
    ...
    public ProductsPage clickOnAddToCart(String productName) {
        driver.element().hoverOverElement(hoverOnProduct(productName))
    ...
    public ProductsPage validateProductDetails(String productName, String productPrice) {
        String actualProductName = driver.element().hoverOverElement(productName(productName)).getText(productName(productName));
        String actualProductPrice = driver.element().hoverOverElement(productName(productName)).getText(this.productPrice(productName));
        ...
        driver.validate().Equals(actualProductPrice, productPrice, "Product price does not match");
        return this;
    }
