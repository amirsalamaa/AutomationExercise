...
public class PaymentPage {
    ...
    public PaymentPage verifyPaymentSuccessMessage(String expectedMessage) {
        driver.verify().Equals(driver.element().getText(paymentSuccessMessage), expectedMessage, "Payment success message");
        return this;
    }

    public PaymentPage verifyDownloadedFile(String invoiceName) {
        driver.verify().assertFileExists(invoiceName, "File is not existed");
        return this;
    }
}
